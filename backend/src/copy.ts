...
const copy: Record<LanguageCode, Record<CopyKey, string>> = {
  "en-IN": {
    ...
    reset: "Done — I cleared everything. Send “Hi” to start over. 🔄",
  ...
  "hi-IN": {
    ...
    reset: "हो गया — मैंने सब कुछ हटा दिया। फिर से शुरू करने के लिए “Hi” भेजें। 🔄",
  ...
  "bn-IN": {
    ...
    reset: "সম্পন্ন — আমি সব মুছে দিয়েছি। আবার শুরু করতে “Hi” পাঠান। 🔄",
  ...
  "te-IN": {
    ...
    reset: "పూర్తయింది — నేను అన్నీ తొలగించాను. మళ్లీ ప్రారంభించడానికి “Hi” పంపండి. 🔄",
  ...
  "mr-IN": {
    ...
    reset: "झाले — मी सर्व काही हटवले. पुन्हा सुरू करण्यासाठी “Hi” पाठवा. 🔄",
  ...
  "ta-IN": {
    ...
    reset: "முடிந்தது — அனைத்தையும் அழித்துவிட்டேன். மீண்டும் தொடங்க “Hi” அனுப்புங்கள். 🔄",
  ...
  "gu-IN": {
    ...
    reset: "થઈ ગયું — મેં બધું કાઢી નાખ્યું. ફરી શરૂ કરવા “Hi” મોકલો. 🔄",
  ...
  "kn-IN": {
    ...
    reset: "ಆಯಿತು — ನಾನು ಎಲ್ಲವನ್ನೂ ಅಳಿಸಿದೆ. ಮತ್ತೆ ಪ್ರಾರಂಭಿಸಲು “Hi” ಕಳುಹಿಸಿ. 🔄",
  ...
  "ml-IN": {
    ...
    reset: "കഴിഞ്ഞു — ഞാൻ എല്ലാം മായ്ച്ചു. വീണ്ടും തുടങ്ങാൻ “Hi” അയക്കൂ. 🔄",
  ...
  "pa-IN": {
    ...
    reset: "ਹੋ ਗਿਆ — ਮੈਂ ਸਭ ਕੁਝ ਹਟਾ ਦਿੱਤਾ। ਦੁਬਾਰਾ ਸ਼ੁਰੂ ਕਰਨ ਲਈ “Hi” ਭੇਜੋ। 🔄",
  ...
  "or-IN": {
    ...
    reset: "ହୋଇଗଲା — ମୁଁ ସବୁ ହଟାଇଦେଲି। ପୁଣି ଆରମ୍ଭ କରିବାକୁ “Hi” ପଠାନ୍ତୁ। 🔄",
