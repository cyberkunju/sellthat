export function Empty(): JSX.Element {
  return (
    <section
      className="rounded-3xl border border-dashed border-stone-300 bg-white px-6 py-16 text-center shadow-card"
      aria-labelledby="empty-heading"
    >
      <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-brand-50 text-2xl" aria-hidden="true">
        🛍️
      </div>
      <h2 id="empty-heading" className="mt-5 text-xl font-semibold text-stone-900">
        No products yet
      </h2>
